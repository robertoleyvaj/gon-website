...
export default function Home() {
  ...
  return (
    <main style={{ fontFamily: 'var(--font-sans)', margin: 0, padding: 0, background: 'var(--cream)', color: 'var(--charcoal)' }}>
      ...
      <section style={{
        ...
        <img
          ...
          style={{
            ...
            height: '100%',
            objectFit: 'cover',
            objectPosition: esMobil ? '75% top' : 'center top',
          }}
        />
        ...
        <div style={{
          ...
          inset: 0,
          background: esMobil
            ? 'linear-gradient(to bottom, rgba(247,244,239,0.88) 0%, rgba(247,244,239,0.72) 55%, rgba(247,244,239,0.0) 100%)'
            : 'linear-gradient(to right, rgba(247,244,239,0.97) 0%, rgba(247,244,239,0.85) 35%, rgba(247,244,239,0.0) 62%)',
        }}/>
        ...
        <div style={{
          ...
          maxWidth: '1180px',
          margin: '0 auto',
          padding: esMobil ? '4.5rem 1.5rem 2.5rem' : '6rem 2rem 0',
        }}>
          <p style={{
            fontFamily: 'var(--font-sans)',
            fontSize: '11px', fontWeight: 500, letterSpacing: '2.5px',
            textTransform: 'uppercase',
            color: esMobil ? 'var(--sage)' : 'var(--sage)',
            marginBottom: '1rem',
          }}>
          ...
          <h1 style={{
            ...
            fontSize: esMobil ? 'clamp(2.4rem, 8vw, 3rem)' : 'clamp(3.2rem, 5vw, 4.4rem)',
            fontWeight: 400,
            lineHeight: 1.08,
            letterSpacing: '-0.02em',
            color: 'var(--charcoal)',
            marginBottom: '1rem',
            maxWidth: esMobil ? '80%' : '560px',
          }}>
            {lang === 'es'
          ...
          <p style={{
            ...
            color: esMobil ? 'var(--charcoal)' : 'var(--warm-gray)',
            lineHeight: 1.8,
            marginBottom: '2rem',
            maxWidth: esMobil ? '85%' : '380px',
            fontWeight: 400,
          }}>
            {t(
          ...
          <div style={{
            ...
            marginBottom: esMobil ? '2rem' : '3rem',
          }}>
            <a href="/Tienda" style={{
              background: 'var(--sage)', color: 'white',
              padding: esMobil ? '13px 28px' : '14px 32px',
              borderRadius: '3px',
              fontFamily: 'var(--font-sans)',
            ...
            <a href="/sunglasses" style={{
              ...
              padding: esMobil ? '12px 28px' : '13px 28px',
              borderRadius: '3px',
              fontFamily: 'var(--font-sans)',
              fontSize: '12px', fontWeight: 500, textDecoration: 'none',
          ...
          <div style={{
            display: 'flex',
            gap: esMobil ? '1.5rem' : '2.5rem',
            flexWrap: 'wrap',
            paddingTop: esMobil ? '1.5rem' : '2rem',
            ...
            {[
              {
                icon: (
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--sage)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              },
              {
                ...
                sub_es: '3 a 5 días hábiles', sub_en: '3–5 business days',
              },
              {
                icon: (
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--sage)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                ...
                <div>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: esMobil ? '12px' : '13px', fontWeight: 500, color: 'var(--charcoal)', lineHeight: 1.3 }}>
                    {t(item.es, item.en)}
                  </div>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', color: 'var(--warm-gray)', marginTop: '1px' }}>
      ...
      {/* ── SHOP BY STYLE ── */}
      <section style={{ padding: esMobil ? '3rem 1.5rem' : '5rem 2rem', maxWidth: '1180px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          {[
            ...
            <a key={i} href={c.href} style={{ textDecoration: 'none', color: 'inherit' }}>
              ...
              >
                <div style={{ height: esMobil ? '100px' : '130px', background: 'var(--cream)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
                ...
                <div style={{ padding: esMobil ? '0.6rem 0.75rem 0.75rem' : '0.9rem 1rem 1rem' }}>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: esMobil ? '12px' : '13px', fontWeight: 500, color: 'var(--charcoal)', marginBottom: '3px' }}>
                    {t(c.es, c.en)}
                  </div>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', color: 'var(--sage)' }}>
      ...
      {/* ── CÓMO FUNCIONA ── */}
      <section id="como-funciona" style={{ background: 'white', padding: esMobil ? '3rem 1.5rem' : '6rem 2rem' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: esMobil ? '1fr 1fr' : 'repeat(4, 1fr)', gap: esMobil ? '0.75rem' : '1.25rem' }}>
            {[
              ...
              <div key={i} style={{ padding: esMobil ? '1.25rem 1rem' : '1.75rem 1.25rem', border: '1px solid var(--border)', borderRadius: '8px', background: 'var(--cream)' }}>
                <div style={{ fontFamily: 'var(--font-serif)', fontSize: esMobil ? '28px' : '34px', fontWeight: 300, color: 'var(--cream-dark)', marginBottom: '0.75rem', lineHeight: 1, WebkitTextStroke: '1px var(--sage-light)' }}>
                  {s.num}
                </div>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: esMobil ? '12px' : '13px', fontWeight: 600, marginBottom: '4px', color: 'var(--charcoal)' }}>{t(s.es, s.en)}</div>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: esMobil ? '11px' : '12px', color: 'var(--warm-gray)', lineHeight: 1.6 }}>{t(s.desc_es, s.desc_en)}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── BANNER PROMO ── */}
      <section style={{ background: 'var(--charcoal)', padding: esMobil ? '3.5rem 1.5rem' : '6rem 2rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontFamily: 'var(--font-sans)', color: 'rgba(255,255,255,0.4)', marginBottom: '2.5rem', fontSize: esMobil ? '13px' : '14px', lineHeight: 1.7 }}>
      ...
      {/* ── FAQ ── */}
      <section id="faq" style={{ padding: esMobil ? '3.5rem 1.5rem' : '7rem 2rem', maxWidth: '660px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        ...
        {[
          ...
          <details key={i} style={{ background: 'white', borderRadius: '8px', border: '1px solid var(--border)', marginBottom: '0.5rem', overflow: 'hidden' }}>
            <summary style={{ padding: '1.1rem 1.5rem', fontFamily: 'var(--font-sans)', fontSize: esMobil ? '13px' : '14px', fontWeight: 500, color: 'var(--charcoal)', cursor: 'pointer', listStyle: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              {t(f.q_es, f.q_en)}
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: 'var(--charcoal)', color: 'rgba(255,255,255,0.35)', padding: esMobil ? '3rem 1.5rem 2rem' : '4rem 2rem 2rem' }}>
