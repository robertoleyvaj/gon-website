...
const materialOpts = [
  ...
  { key: 'thin',     nombre_es: 'Poly Plus',      nombre_en: 'Poly Plus',       precio: 29, grosor: 2, peso: 2, indice: '1.58',
    desc_es: 'Policarbonato resistente a impactos. Para uso diario y personas activas.', desc_en: 'Impact-resistant polycarbonate. For daily use and active people.',
    tip_es: 'Policarbonato 1.58. Muy resistente a impactos. Ideal para niños, deportistas o uso rudo. Más delgado que Essential.', tip_en: 'Polycarbonate 1.58. Highly impact-resistant. Ideal for kids, sports or heavy use. Thinner than Essential.',
    grad_es: 'Hasta ±4.00 dioptrías', grad_en: 'Up to ±4.00 diopters' },
  { key: 'hd',      nombre_es: 'Slim HD',        nombre_en: 'Slim HD',         precio: 22, grosor: 3, peso: 3, indice: '1.60',
    desc_es: 'Hi-Index más delgado. Ideal para graduaciones medias.', desc_en: 'Thinner Hi-Index. Ideal for mid-range prescriptions.',
    tip_es: 'Hi-Index 1.60. Más delgado y ligero que el policarbonato. Para graduaciones medias donde la estética importa.', tip_en: 'Hi-Index 1.60. Thinner and lighter than polycarbonate. For mid-range prescriptions where aesthetics matter.',
